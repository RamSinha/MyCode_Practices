...
import com.careem.streaming.examples.api.dao.ServiceDAO.{DriverPingInfo, LeadInfo, TripRequestData}
import com.careem.streaming.examples.api.repository.impl.{DriverPingInfoRepository, PFLeadDataRepository, TripDataRepository}
