package com.tutorial.streaming.examples.api.service.http
...
import com.tutorial.streaming.examples.api.exceptions.{APIException, MalformedRequestException}
import com.tutorial.streaming.examples.api.service.http.routes.ServiceRoutes
